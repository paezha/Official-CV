...
Fig. \ref{fig:reviews-annual-summary} is a summary of journal reviews per year.

```{r reviews-per-year, fig.cap="\\label{fig:reviews-annual-summary}Number of journal reviews per year"}
referee %>%
  group_by(Year) %>%
